...
import com.szxb.wxx.library.h510.PrinterCommand;
...
//        PrinterInterface.PrinterClose();
    ...
    public static void printBitmapGSVMSB(Bitmap bm, int bitMarginLeft, int bitMarginTop) {
        ...
        // Log.e("-----","PBU193 "+resultP );
        // int resultI = PrinterInterface.PrinterQuery();
        // Log.e("-----","PBU195 "+resultP );
        // if (resultI == 0) {
        // Log.e("------", " 请添加打印纸");
        // // LogHelper.infoAppendMsgForFailed("请添加打印纸");
        // }
