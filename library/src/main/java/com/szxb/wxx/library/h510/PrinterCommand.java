...
public class PrinterCommand 
{
    ...
    /**
     * 
     * 打印行缓冲区里的内容,并向前走�?n 点行�?该命令只对本行有�?不改�?ESC 2,ESC 3 命令设置的行间距值�?
     * 
     * @param n
     *            0-255
     * @return
    ...
    /**
     * 打印行缓冲区里的内容,并向前走�?n 行�? 行高�?ESC 2,ESC 3 设定的�?
     * 
     * @param n
     *            0-255
     * @return
    ...
    /**
     * 1:打印机处于连线模�?接受打印数据并打�?0:打印机处于离线模�?不接受打印数�?
     * 
     * @param n
     *            :0,1�?��位有�?
     * @return
    ...
    /**
     * 设置打印行的对齐方式,缺省:左对�?0 �?n �?2 �?48 �?n �?50 左对�? n=0,48 居中对齐: n=1,49 右对�?
     * n=2,50
     * 
     * @param n
     *            :0 �?n �?2 �?48 �?n �?50
    ...
    /**
     * 设置打印的左边距,缺省�?0。左边距�?nL+nH*256,单位 0.125mm
     * 
     * @param nL
     * @param nH
     * @return
    ...
    /**
     * 设置打印的左边距,缺省�?0 左边距为 nL+nH*256,单位 0.125mm
     * 
     * @param nL
     * @param nH
     * @return
     ...
     * 
     * @param n
     *            �?0:保留 �?1:1:字体反白 �?2:1:字体上下倒置 �?3:1:字体加粗 �?4:1:双�?高度 �?
     *            5:1:双�?宽度 �?6:1:删除�?
     * @return
     */
    ...
    /**
     * n 的低 4 位表示高度是否放�?等于 0 表示不放�?n 的高 4 位表示宽度是否放�?等于 0 表示不放�?
     * 
     * @param n
     * @return
     */
    ...
    /**
     * 该命令之后所有字符均以正常宽度的 2 倍打�? 该命令可以用回车或�? DC4 命令删除�?
     * 
     * @return
     */
     ...
     * 
     * @param n
     *            国际字符集设置如�?0:USA 1:France 2:Germany 3:U.K. 4:Denmark 1 5:Sweden
    ...
    /**
     * 选择字符代码�?字符代码页用于�?�?0x80~0xfe 的打印字符�?中文版本不支持该命令
     * 
     * @param n
     *            字符代码页参数如 �?0:437 1:850
     * @return
     */
    ...
    /**
     * 当有效时,打印机发现状态改�?则自动发送状态到主机。详细参照ESC/POS指令级�?
     * 
     * @param n
     * @return
     */
    ...
    /**
     * 向主机传送周边设备状�?仅对串口型打印机有效。该命令不支持�?详细参照ESC/POS指令集�?
     * 
     * @param n
     * @return
     */
